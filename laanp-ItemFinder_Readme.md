...
## Known bugs/features:
- Single player mode can access all storage/bench inventory locations throughout the entire map.
- Clients in dedicated server or hosted multiplayer will only be able to see storage/benches within a 2-3 grid radius of player.
- Each player has their own copy of custom saved storage/bench names for each map-prospect. 
