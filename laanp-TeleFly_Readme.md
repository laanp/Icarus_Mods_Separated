...
- Introduces a new craftable icon called "Petes TeleFly" which you can craft in the character inventory.
- This mod turns off all fall damage and out-of-bounds warnings/death!
- When placed in your Quickbar and activated, Use:
  - Tap LMB - To quick launch in any direction and sets player into "Fly" mode
  - Once in "Fly" mode, use movement keys & mouse pointer to direct flying player, or tap LMB to jump 600 units in any direction.
  - To teleport to a location (ground, building, etc), point the cursor to your destination and hold the LMB down (for 1 second).
  - When flying, tap RMB and wait a second to fall to the ground, and sets player back to normal walking mode.   
  - Holding RMB will stay in fly mode, but will stop all movement, so you are still in the air.
  - Holding LSHIFT + Forward key will fast accelerate your flying speed.
  - Hold Left-CRTL to lower quickly.
  - Hold Space bar to raise quickly.
