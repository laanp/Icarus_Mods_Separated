...
- Some items that have animation may render the animation strangely after resizing.
...
- Ensure you are running the latest version of this mod with the latest version of Icarus.  Hint: the _w218_ in the mod file name means mod is compatible with Week 218 Icarus release.  
