...
## Mod Details:
- Have a cave worm phobia? Hate the buzzing?
  This mod completely removes them from Missions & Open World prospects in the game.
- Does not remove Boss Sand Worm or worms spawning from the use of the Thumper. 
- For mission prospects,  make sure you keep a current version of this mod installed.
  If this mod is removed and you resume a mission, the mod effects will be removed and cave creatures will spawn.  
  This will remain in effect for the duration of the mission, even if you re-install the mod. 
