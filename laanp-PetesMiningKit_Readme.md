...
### "Pete's Mining Kit"
You might see a "Komodo Bite" modifier state showing, when you hovering over the "Pete's Ice Borer" with your mouse cursor. 
This does not affect the player, and can be ignored.
