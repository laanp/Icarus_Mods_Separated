...
- Adds new Workshop equipment, including:
     - "Pete's Nuclear Extractor" - Custom self-powered exotic (purple) extractors - Fast extraction!
       - Extractor have reduced weight, and can be carried & stacked in regular inventory (not in the G-slot)
       - Equipment can be returned to the station.
